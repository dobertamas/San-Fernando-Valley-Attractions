...
public class RestaurantsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        restaurantsList.add(new Attraction("Pronpiya Thai BBQ", "345 W Los Angeles Ave Moorpark, CA", "Quite spicey", "https://www.facebook.com/Pronpiya-Thai-BBQ-148202158543286/", -1));
        restaurantsList.add(new Attraction("Atlas Kitchen", "1368 Madera Rd Simi Valley, CA", "Good Persian/Iranian", "http://atlasmediterranean.wix.com/kitchen", -1));
        restaurantsList.add(new Attraction("Pita Pockets", "9127 Reseda Blvd Northridge, CA", "Middle Eastern", "https://www.facebook.com/Pita-Pockets-128793943860371/", -1));
        restaurantsList.add(new Attraction("Oi Asian Fusion", "7242 Canoga Ave, Canoga Park, CA", "Filipino adobo bowls", "http://www.oiasianfusion.com/", -1));
        restaurantsList.add(new Attraction("Greek House Cafe", "2375 Sycamore Dr Simi Valley, CA", "Greek food", "https://greekhousecafe.com", R.drawable.atlas_greek));
